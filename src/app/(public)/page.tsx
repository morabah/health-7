    ...
    <>
      ...
      <section className="text-center py-16 md:py-24 px-4">
        ...
        <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto mb-8">
          Connect with doctors, schedule appointments, and manage your health journey — all in one
          secure place.
        </p>
        ...
        <div
          className="mt-12 h-64 sm:h-80 lg:h-96 w-full max-w-4xl mx-auto
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Browse qualified doctors by specialty, location, and availability to find the
            ...
            <Card className="p-6 flex flex-col items-center text-center">
              ...
              <p className="text-slate-600 dark:text-slate-400">
                Book appointments with just a few clicks and receive instant confirmations and
                reminders.
              </p>
            </Card>
            ...
            <Card className="p-6 flex flex-col items-center text-center">
              ...
              <h3 className="text-xl font-semibold mb-2">Access your records anywhere</h3>
              <p className="text-slate-600 dark:text-slate-400 mb-3">
                Your medical information is safely stored and accessible from any device. We&apos;ve
                made it simple.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <Card className="p-6">
              <p className="text-slate-600 dark:text-slate-400 mb-4 italic">
                &quot;This platform has transformed how I manage my healthcare. Finding specialists
                and booking appointments is now seamless and stress-free.&quot;
              </p>
            ...
            <Card className="p-6">
              <p className="text-slate-600 dark:text-slate-400 mb-4 italic">
                &quot;As a doctor, this system has helped me organize my schedule efficiently and
                connect with patients who truly need my expertise.&quot;
              </p>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-slate-200 dark:bg-slate-700 rounded-full mr-3"></div>
                <div>
