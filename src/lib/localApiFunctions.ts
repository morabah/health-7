...
export async function findDoctors(
  ...
  try {
    ...
    const docList = doctors
      .map(doc => {
        ...
        return {
          ...
          verificationNotes:
            typeof doc.verificationNotes === 'string' || doc.verificationNotes === null
          ...
          education:
            typeof doc.education === 'string' || doc.education === null ? doc.education : null,
          servicesOffered:
            typeof doc.servicesOffered === 'string' || doc.servicesOffered === null
              ? doc.servicesOffered
              : null,
          languages: Array.isArray(doc.languages) ? doc.languages : [],
          consultationFee:
            typeof doc.consultationFee === 'number' || doc.consultationFee === null
              ? doc.consultationFee
              : null,
          profilePictureUrl:
            typeof doc.profilePictureUrl === 'string' || doc.profilePictureUrl === null
              ? doc.profilePictureUrl
              : null,
          profilePicturePath:
            typeof doc.profilePicturePath === 'string' || doc.profilePicturePath === null
              ? doc.profilePicturePath
              : null,
          licenseDocumentUrl:
            typeof doc.licenseDocumentUrl === 'string' || doc.licenseDocumentUrl === null
              ? doc.licenseDocumentUrl
              : null,
          licenseDocumentPath:
            typeof doc.licenseDocumentPath === 'string' || doc.licenseDocumentPath === null
              ? doc.licenseDocumentPath
              : null,
          certificateUrl:
            typeof doc.certificateUrl === 'string' || doc.certificateUrl === null
              ? doc.certificateUrl
              : null,
          certificatePath:
            typeof doc.certificatePath === 'string' || doc.certificatePath === null
              ? doc.certificatePath
              : null,
          ...
          weeklySchedule:
            doc.weeklySchedule && typeof doc.weeklySchedule === 'object'
              ? doc.weeklySchedule
              : {
                  monday: [],
                  tuesday: [],
    ...
    if (role === UserType.DOCTOR) {
      ...
      filteredDocs = filteredDocs.filter(d => d.isActive);
    }
...
type JoinedDoctor = z.infer<typeof DoctorProfileSchema> & {
  id: string;
  firstName: string;
  lastName: string;
  isActive: boolean;
...
export async function getDoctorPublicProfile(ctx: {
  ...
  try {
    ...
    const profile: z.infer<typeof DoctorProfileSchema> = {
      ...
      verificationNotes:
        typeof doctor.verificationNotes === 'string' || doctor.verificationNotes === null
          ? doctor.verificationNotes
          : null,
      adminNotes: typeof doctor.adminNotes === 'string' ? doctor.adminNotes : undefined,
      location:
        typeof doctor.location === 'string' || doctor.location === null ? doctor.location : null,
      education:
        typeof doctor.education === 'string' || doctor.education === null ? doctor.education : null,
      servicesOffered:
        typeof doctor.servicesOffered === 'string' || doctor.servicesOffered === null
          ? doctor.servicesOffered
          : null,
      languages: Array.isArray(doctor.languages) ? doctor.languages : [],
      consultationFee:
        typeof doctor.consultationFee === 'number' || doctor.consultationFee === null
          ? doctor.consultationFee
          : null,
      profilePictureUrl:
        typeof doctor.profilePictureUrl === 'string' || doctor.profilePictureUrl === null
          ? doctor.profilePictureUrl
          : null,
      profilePicturePath:
        typeof doctor.profilePicturePath === 'string' || doctor.profilePicturePath === null
          ? doctor.profilePicturePath
          : null,
      licenseDocumentUrl:
        typeof doctor.licenseDocumentUrl === 'string' || doctor.licenseDocumentUrl === null
          ? doctor.licenseDocumentUrl
          : null,
      licenseDocumentPath:
        typeof doctor.licenseDocumentPath === 'string' || doctor.licenseDocumentPath === null
          ? doctor.licenseDocumentPath
          : null,
      certificateUrl:
        typeof doctor.certificateUrl === 'string' || doctor.certificateUrl === null
          ? doctor.certificateUrl
          : null,
      certificatePath:
        typeof doctor.certificatePath === 'string' || doctor.certificatePath === null
 ...
 */
export async function getDoctorAvailability(ctx: {
  uid: string;
  role: UserType;
  doctorId: string;
}): Promise<
...
> {
  ...
  try {
    ...
    try {
      ...
      // Import at file level to avoid dynamic import issues
