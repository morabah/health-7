 ...
 */
export function setBrowserCacheData<T>(category: CacheCategory, key: string, data: T): boolean {
  if (typeof window === 'undefined') {
    return false;
  }
 ...
 */
export function getBrowserCacheData<T>(category: CacheCategory, key: string): T | undefined {
  if (typeof window === 'undefined') {
    return undefined;
  }
