    ...
    return (
      <div className="w-full space-y-2">
        ...
        <select
          ...
          className={twMerge(
            clsx(
              'w-full h-10 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-primary/60 ring-offset-2 transition-colors duration-200 ease-in-out',
              error 
